        ...
        <Row>
          ...
          <Col md={9} lg={10} className="ms-sm-auto px-md-4">
            <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
              <h1 className="h2">Quản lý hệ thống</h1>
              ...
              <Col md={4} className="mb-3">
                <Card className="h-100 shadow-sm">
                  <Card.Body>
                    ...
                    <div className="mt-3">
                      <Link to="/superadmin/admins" className="btn btn-sm btn-outline-primary">Xem chi tiết</Link>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={4} className="mb-3">
                <Card className="h-100 shadow-sm">
                  <Card.Body>
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        <h5 className="card-title">Tổng số đội</h5>
                    ...
                    <div className="mt-3">
                      <Link to="/superadmin/teams" className="btn btn-sm btn-outline-success">Xem chi tiết</Link>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={4} className="mb-3">
                <Card className="h-100 shadow-sm">
                  <Card.Body>
                    ...
                    <div className="mt-3">
                      <Link to="/superadmin/invite-codes" className="btn btn-sm btn-outline-warning">Quản lý</Link>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={4} className="mb-3">
                <Card className="h-100 shadow-sm">
                  <Card.Body>
                    ...
                    <div className="mt-3">
                      <Link to="/superadmin/notifications" className="btn btn-sm btn-outline-info">Quản lý</Link>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={4} className="mb-3">
                <Card className="h-100 shadow-sm">
                  <Card.Body>
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        <h5 className="card-title">Nhật ký</h5>
                    ...
                    <div className="mt-3">
                      <Link to="/superadmin/logs" className="btn btn-sm btn-outline-secondary">Xem nhật ký</Link>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col md={4} className="mb-3">
                <Card className="h-100 shadow-sm">
                  <Card.Body>
                    ...
                    <div className="mt-3">
                      <Link to="/superadmin/database" className="btn btn-sm btn-outline-danger">Quản lý</Link>
                    </div>
                  </Card.Body>
                </Card>
              </Col>
