export const translations = {
  ...
  en: {
    ...
    game_note_note: 'This note will be displayed to all teams when they participate',
    teams_label: 'Team Names',
    add_team: 'Add',
    add_multiple_teams: 'Add Multiple Teams',
    teams_input_note: 'Enter a team name and press "Add" or enter a comma-separated list of teams',
